...
class _AddFoodPageState extends State<AddFoodPage> {
  ...
  Widget build(BuildContext context) {
    return ShowCaseWidget(onFinish: () {
      ...
      Get.find<ShowcaseController>().setShowcase(KEY_SHOWCASE_ADD_FOOD_SCREEN);
    }, builder: Builder(builder: (context) {
      AddFoodController ctrl1 = Get.find<AddFoodController>();
      //? 'showcaseAddFoodPage' check if false then only show tour
      if (!Get.find<ShowcaseController>().showcaseAddFoodPage) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ShowCaseWidget.of(context).startShowCase([
            ctrl1.showcaseAddCategory,
            ctrl1.showcaseUploadFoodImg,
            ctrl1.showcaseEnterFoodDetails,
            ctrl1.showcaseMultiplePrice,
            ctrl1.showcaseSubmitFood,
          ]);
        });
      }
                              ...
                              child: Column(
                                ...
                                children: [
                                            ...
                                            itemBuilder: (BuildContext ctx, index) {
                                              ...
                                              if (index < ctrl.myCategory.length) {
                                                return CategoryCard(
                                                  ...
                                                  color:
                                                      ctrl.tappedIndex == index ? AppColors.mainColor_2 : Colors.white,
                                              ...
                                              //? add new category card
                                                ...
                                                return AnimatedCrossFade(
                                                  firstChild: MyShowCase(
                                                    showcaseKey: ctrl.showcaseAddCategory,
                                                    description: 'Add Category - Eg: BREAKFAST',
                                  ...
                                  ctrl.imageFile != null
                                      ...
                                      : MyShowCase(
                                          showcaseKey: ctrl.showcaseUploadFoodImg,
                                  ...
                                  5.verticalSpace,
                                  MyShowCase(
                                    showcaseKey: ctrl.showcaseEnterFoodDetails,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      MyShowCase(
                                        showcaseKey: ctrl.showcaseMultiplePrice,
                                        description: 'To Add Multiple Price',
                                        targetPadding: 5,
                                        child: MyToggleSwitch(
                                          ...
                                          onToggle: (val) {
                                            ...
                                            //? showing showCase at first time
                                            if (!Get.find<ShowcaseController>().showcaseAddFoodPagePriceNameCard) {
                                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                                ShowCaseWidget.of(context)
                                                    .startShowCase([ctrl1.showcaseMultiplePriceNameCard]);
                                              });
                                              //? set false after show
                                              Get.find<ShowcaseController>()
                                                  .setShowcase(KEY_SHOWCASE_ADD_FOOD_SCREEN_PRICE_NAME_CARD);
                                            }
                                          },
                                        ),
                                      ),
                                      ...
                                      children: [
                                        Expanded(
                                          child: Column(
                                            children: [
                                              ConditionalWrapper(
                                                condition: ctrl.priceToggle,
                                                wrapper: (Widget child) {
                                                  return MyShowCase(
                                                    showcaseKey: ctrl.showcaseMultiplePriceNameCard,
                                                    description: 'Click To Change Name',
                                                    targetPadding: 5,
                                                    child: child,
                                                  );
                                                },
                                                child: BeautifulStripCard(
                                  ...
                                  Center(
                                      child: ctrl.isLoading
                                          ...
                                          : MyShowCase(
                                              showcaseKey: ctrl.showcaseSubmitFood,
                                              description: 'Finally Add Your Food',
                                              targetPadding: 10,
                                              child: RoundBorderButton(
                                                ...
                                                borderRadius: 20.r,
                                                onTap: () async {
                                                  if (ctrl.selectedCategory == -1) {
                                                    WidgetsBinding.instance.addPostFrameCallback((_) {
                                                      ShowCaseWidget.of(context)
                                                          .startShowCase([ctrl.showcaseAddCategory]);
                                                    });
                                                  }
